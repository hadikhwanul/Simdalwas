            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{ route('account-center.update', $user->username) }}" method="POST"
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <select id="inputKelompok" class="form-select" name="kelompok" required>
                                        ...
                                        <option value="Admin"
                                            {{ old('kelompok', $user->kelompok) == 'Admin' ? 'selected' : '' }}>
                                            Admin
                                        </option>
                                        <option value="Pimpinan"
                                            {{ old('kelompok', $user->kelompok) == 'Pimpinan' ? 'selected' : '' }}>
                                            Pimpinan
                                        </option>
                                        <option value="Sekretaris"
                                            {{ old('kelompok', $user->kelompok) == 'Sekretaris' ? 'selected' : '' }}>
                                            Sekretaris
                                        </option>
                                        <option value="Sub. Perencanaan"
                                            {{ old('kelompok', $user->kelompok) == 'Sub. Perencanaan' ? 'selected' : '' }}>
                                            Sub. Perencanaan
                                        </option>
                                        <option value="Sub. Evaluasi & Pelaporan"
                                            {{ old('kelompok', $user->kelompok) == 'Sub. Evaluasi & Pelaporan' ? 'selected' : '' }}>
                                            Sub. Evaluasi & Pelaporan
                                        </option>
                                        <option value="IRBAN I"
                                            {{ old('kelompok', $user->kelompok) == 'IRBAN I' ? 'selected' : '' }}>
                                            IRBAN I
                                        </option>
                                        <option value="IRBAN II"
                                            {{ old('kelompok', $user->kelompok) == 'IRBAN II' ? 'selected' : '' }}>
                                            IRBAN II
                                        </option>
                                        <option value="IRBAN III"
                                            {{ old('kelompok', $user->kelompok) == 'IRBAN III' ? 'selected' : '' }}>
                                            IRBAN III
                                        </option>
                                        <option value="IRBAN IV"
                                            {{ old('kelompok', $user->kelompok) == 'IRBAN IV' ? 'selected' : '' }}>
                                            IRBAN IV
                                        </option>
                                        <option value="IRBAN V"
                                            {{ old('kelompok', $user->kelompok) == 'IRBAN V' ? 'selected' : '' }}>
                                            IRBAN V
                                        </option>
                                    </select>
                                </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <select id="inputRole" class="form-select" name="jobdesk_id" required>
                                        ...
                                        @forelse ($role as $rl)
                                            <option value="{{ $rl->id }}"
                                                {{ old('jobdesk_id', $user->jobdesk_id) == $rl->id ? 'selected' : '' }}>
                                                {{ $rl->role }}
                                            </option>
                                        @empty
                                        @endforelse
