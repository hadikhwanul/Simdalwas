    ...
    <main>
        <div class="container">
            ...
            <section
                            ...
                            <div class="card mb-3">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="pt-4 pb-2">
                                        ...
                                        <p class="text-center small">Masukkan Email/Username dan Password</p>
                                    </div>
                                        ...
                                        <div class="col-12">
                                            ...
                                            <div class="input-group has-validation">
                                                <input type="text" name="identity"
                                                    ...
                                                    id="identity" value="{{ old('identity') }}"
                ...
                <footer class="py-4">
                    &nbsp; &copy; Copyright <strong><span>INSPEKTORAT LOMBOK TIMUR</span></strong>.
                    <div class="credits pe-3 text-center">
