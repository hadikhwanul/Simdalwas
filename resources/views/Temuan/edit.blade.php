...
@section('main')
    ...
    <section class="section">
        <div class="row">
            ...
            <form action="{{ route('temuan.update', ['draft' => $lhp->slug, 'temuan' => $temuan->id]) }}" method="POST"
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="row g-3">
                            <h5 class="card-title">Form Edit Temuan</h5>
                            <!-- Temuan Field -->
                            <div class="col-md-6">
                                ...
                                <input id="temuan" type="hidden" name="temuan"
                                    ...
                                    value="{{ old('temuan', $temuan->temuan) }}">
                                <trix-editor input="temuan">{!! old('temuan' || $temuan->temuan) !!}</trix-editor>
                                @error('temuan')
                            ...
                            <div class="col-md-6">
                                ...
                                <input id="keterangan" type="hidden" name="keterangan"
                                    ...
                                    value="{!! old('keterangan', $temuan->keterangan) !!}">
                                <trix-editor input="keterangan">{!! old('keterangan' || $temuan->keterangan) !!}</trix-editor>
                                @error('keterangan')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <select id="pokok_temuan" class="form-select" name="pokok_temuan" required>
                                    ...
                                    @foreach ($pokok_temuan as $temuanItem)
                                        <option value="{{ $temuanItem->no_pokok }}"
                                            {{ old('pokok_temuan', $temuan->pokok_temuan) == $temuanItem->no_pokok ? 'selected' : '' }}>
                                            {{ $temuanItem->no_pokok }}. {{ $temuanItem->pokok_temuan }}
                                        </option>
                                    @endforeach
                                </select>
                            </div>
                                ...
                                <select id="sub_pokok_temuan" class="form-select" name="pokok_temuan_id" required>
                                    ...
                                    @foreach ($sub_pokok_temuan as $sub)
                                        <option value="{{ $sub->id }}" data-no-pokok="{{ $sub->no_pokok }}"
                                            {{ old('pokok_temuan_id', $temuan->pokok_temuan_id) == $sub->id ? 'selected' : '' }}>
                        ...
                        <div class="row g-3">
                                ...
                                <select id="pokok_penyebab" class="form-select" name="pokok_penyebab" required>
                                    ...
                                    @foreach ($pokok_penyebab as $penyebab)
                                        <option value="{{ $penyebab->no_pokok }}"
                                            {{ old('pokok_penyebab', $temuan->pokok_penyebab) == $penyebab->no_pokok ? 'selected' : '' }}>
                            ...
                            <div class="col-md-6">
                                ...
                                <input id="penyebab" type="hidden" name="penyebab"
                                    ...
                                    value="{{ old('penyebab', $temuan->penyebab) }}">
                                <trix-editor input="penyebab">{!! old('penyebab', $temuan->penyebabs->first()->penyebab) !!}</trix-editor>
                                @error('penyebab')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-6" style="margin-top:-5%">
                                ...
                                <select id="sub_pokok_penyebab" class="form-select" name="id_pokok_penyebab" required>
                                    ...
                                    @foreach ($sub_pokok_penyebab as $sub)
                                        <option value="{{ $sub->id }}" data-no-pokok="{{ $sub->no_pokok }}"
                                            {{ old('id_pokok_penyebab', $temuan->id_pokok_penyebab) == $sub->id ? 'selected' : '' }}>
                        ...
                        <div class="row g-3">
                                ...
                                <select id="pokok_rekomendasi" class="form-select" name="pokok_rekomendasi" required>
                                    ...
                                    @foreach ($pokok_rekomendasi as $rekomendasi)
                                        <option value="{{ $rekomendasi->no_pokok }}"
                                            {{ old('pokok_rekomendasi', $temuan->pokok_rekomendasi) == $rekomendasi->no_pokok ? 'selected' : '' }}>
                            ...
                            <div class="col-md-6">
                                ...
                                <input id="rekomendasi" type="hidden" name="rekomendasi"
                                    ...
                                    value="{{ old('rekomendasi', $temuan->rekomendasi) }}">
                                <trix-editor input="rekomendasi">{!! old('rekomendasi', $temuan->rekomendasis->first()->rekomendasi) !!}</trix-editor>
                                @error('rekomendasi')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-6" style="margin-top: -6%">
                                ...
                                <select id="sub_pokok_rekomendasi" class="form-select" name="pokok_rekomendasi_id"
                                    ...
                                    @foreach ($sub_pokok_rekomendasi as $sub)
                                        <option value="{{ $sub->id }}" data-no-pokok="{{ $sub->no_pokok }}"
                                            {{ old('pokok_rekomendasi_id', $temuan->pokok_rekomendasi_id) == $sub->id ? 'selected' : '' }}>
                            ...
                            <div class="col-md-6" style="margin-top: 3%">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" class="form-control @error('kerugian') is-invalid @enderror"
                                        name="kerugian"
                                        value="{{ old('kerugian', $temuan->rekomendasis->first()->kerugian) }}"
                                        id="kerugian" onkeyup="formatRupiah(this)">
                                    @error('kerugian')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6" style="margin-top: -7.5%">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" class="form-control @error('kewajiban') is-invalid @enderror"
                                        name="kewajiban"
                                        value="{{ old('kewajiban', $temuan->rekomendasis->first()->kewajiban) }}"
                                        id="kewajiban" onkeyup="formatRupiah(this)">
                                    @error('kewajiban')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                ...
                <button type="submit" class="btn btn-primary mt-4">Update Temuan</button>
            </form>
